...
- Not when cursor is on top uf them (possibly about to click)
- When the last modified time of the most recently modified item shows that the content has changed.
## Pinned Epic
- Create pending items in a buffer to hide delay
- Modify the refresh so the server has more time to register the change
- Make the panel invisible when no topic is pinned
- Somehow automatically ask if you want to pin epics assigned to you in Jira.
## Automatically assign tickets to you when you press play on them
